...
public class ClubFaceCorrectionDatatableAdjustmentView : UserControl, IComponentConnector
{
	internal DataGrid SpinDataTable;

	private bool URhbYnT0x;

	public ClubFaceCorrectionDatatableAdjustmentView()
	{
	...
	public void InitializeComponent()
	{
		...
		{
			URhbYnT0x = true;
			Uri uri = new Uri(QQXBLjLprwI58ya4VR.y8v8TMFOCb(832), UriKind.Relative);
