...
public class WoodBackspinModelPrediction
{
	public class ModelInput
	{
		[CompilerGenerated]
		private float EUBMDHvY6K;

		[CompilerGenerated]
		private float TjYMTYoKl5;

		[CompilerGenerated]
		private float qxXMCvoi0e;

		[CompilerGenerated]
		private float kAlMM7HIk8;

		[CompilerGenerated]
		private float e05MKrPX95;
	...
	{
		[CompilerGenerated]
		private float gu3MpD2k6X;

		[CompilerGenerated]
		private float Y8TM7iTqMd;

		[CompilerGenerated]
		private float RRYM8aLYUE;

		[CompilerGenerated]
		private float QTtMul8J9X;

		[CompilerGenerated]
		private float GwjMY6G1AN;

		[CompilerGenerated]
		private float[] LwcMbXFA1b;

		[CompilerGenerated]
		private float lxiMfoDdRZ;
	...
	private static string Usovjmy7go;
	...
	private static PredictionEngine<ModelInput, ModelOutput> AavvAAKtvp()
	{
		MLContext mLContext = new MLContext();
		DataViewSchema inputSchema;
		ITransformer transformer = mLContext.Model.Load(Usovjmy7go, out inputSchema);
	...
	public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
	{
		...
		}).Append(mlContext.Transforms.Concatenate(YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(7962), YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(7874), YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(7896), YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(7922), YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(7942))).Append(mlContext.Regression.Trainers.FastTree(new FastTreeRegressionTrainer.Options
		{
			...
			FeatureFraction = 0.841929764001533,
			LearningRate = 0.19898004126198,
	...
	public WoodBackspinModelPrediction()
	{
		fhYaaMbcaIbkDahgc9.PdVWL95B80ZOj();
		base._002Ector();
	}

	static WoodBackspinModelPrediction()
	{
		fhYaaMbcaIbkDahgc9.PdVWL95B80ZOj();
		Usovjmy7go = Path.GetFullPath(YMYMvTu0UxT5Rn8kmF.ahYK8ZsYu6(8174));
		PredictEngine = new Lazy<PredictionEngine<ModelInput, ModelOutput>>(() => AavvAAKtvp(), isThreadSafe: true);
	}
}
