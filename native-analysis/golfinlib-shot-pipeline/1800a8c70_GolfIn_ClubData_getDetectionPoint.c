FUNCTION: GolfIn::ClubData::getDetectionPoint
ENTRY: 1800a8c70
REASONS: name:club


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */
/* public: class cv::Point_<float> __cdecl GolfIn::ClubData::getDetectionPoint(int const &
   __ptr64,bool const & __ptr64) __ptr64 */

int * __thiscall GolfIn::ClubData::getDetectionPoint(ClubData *this,int *param_1,bool *param_2)
